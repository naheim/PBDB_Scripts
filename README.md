...
There are two timescales. The native PBDB timescale, which is based on the International Comission on Stratigraphy 2013 timescale. The other is from the ``fossilbrush`` R package and is based on the Gradstein 2020 timescale (i.e., the current ICS Timescale).


* [timescale_2013.csv](Timescale/timescale_2013.csv)
* [timescale_2020.csv](Timescale/timescale_2020.csv)

```{r}
timescale.2013 <- read.csv(file="https://raw.githubusercontent.com/naheim/PBDB_Scripts/master/Timescale/timescale_2013.csv")
